...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		if((keyPressed >=97 && keyPressed<=122)|| (keyPressed >=65 && keyPressed<=90))
		{
			...
			numberkey();
			document.getElementById("d1").innerHTML="Voce pressionou uma tecla de numeros";
		}

		else if((keyPressed >=37 && keyPressed<=40)){
			arrowkey();
			document.getElementById("d1").innerHTML="Voce pressionou uma tecla de direção";
		}

		else if((keyPressed == 17) || (keyPressed == 18) || (keyPressed == 27)){
			specialkey();
			document.getElementById("d1").innerHTML="Voce pressionou uma especial";
		}

		else{
			otherkey();
			document.getElementById("d1").innerHTML="Voce pressionou uma tecla de simbolos ou outros";
		}
